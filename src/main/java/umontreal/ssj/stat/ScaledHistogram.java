...
public class ScaledHistogram {
   ...
   protected String axisOptions = "";     //!< PGFPlots options appended to the axis environment in toLatex().
   protected String addPlotOptions = "";  //!< PGFPlots options appended to each addplot command in toLatex().
   ...
   public ScaledHistogram clone() {
      ...
      // Preserve the LaTeX customization options when a transformed histogram is cloned.
   ...
   /**
    * Sets additional PGFPlots options for the axis environment generated by
    * \c toLatex.
    *
    * The string must contain comma-separated options, without the surrounding
    * square brackets.
    *
    * For example:
    * @code
    * setAxisOptions("title={My title}, xlabel={$x$}, width=8cm, height=5cm");
    * @endcode
    *
    * If \c str is \c null, the options are reset to the empty string.
    *
    * @param str the axis options to append
    */
   ...
   /**
    * Sets additional PGFPlots options for the addplot commands generated by
    * \c toLatex.
    *
    * The string must contain comma-separated options, without the surrounding
    * square brackets.
    ...
    * For example:
    * @code
    * setAddPlotOptions("fill=blue!30, draw=black");
    * @endcode
    *
    * If \c str is \c null, the options are reset to the empty string.
    *
    * @param str the addplot options to append
    */
