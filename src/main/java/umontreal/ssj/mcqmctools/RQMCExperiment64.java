 ...
 * 
 */
public class RQMCExperiment64 extends MonteCarloExperiment {
    ...
    * `statReps`. Here the QMC point set `p`, its randomization `rand`, and also the iterator, are
    * specified directly.
    */
   ...
   public static void simulReplicatesRQMC(MonteCarloModelDouble model, PointSet p, PointSetRandomization rand, int m,
      ...
      simulReplicatesRQMC (model, p, iter, rand, m, statReps);
   }
   ...
   public static String makeComparisonExperimentMCvsRQMC(MonteCarloModelDouble model, RandomStream stream, PointSet p,
      ...
      pf.append(RQMCExperiment64.simulReplicatesRQMCDefaultReportCompare(model, p, rand, m, statRQMC, statMC.variance(),
            secPerRunMC));
      return pf.toString();
   }
