 ...
 */
public class NestedUniformScramblingNoCache implements PointSetRandomization {
    ...
    * Empty constructor.
    */
   public NestedUniformScramblingNoCache() {
      this(null);
   }
    ...
    */
   public NestedUniformScramblingNoCache(RandomStream stream) {
      this(stream, 0);
   }
    ...
    */
   public NestedUniformScramblingNoCache(RandomStream stream, int numBits) {
      this.stream = stream;
   ...
   public void randomize(PointSet p) {
      if (p instanceof DigitalNetBase2) {}
         // p.setupNUS64(numBits);  // We redo the setup each time we randomize!!!
        //  ((DigitalNetBase2)p).setupNUS64(numBits);  // We redo the setup each time we randomize!!!
      else throw new IllegalArgumentException(
            "NestedUniformScramblingNoCache" + " can only randomize a DigitalNetBase2");
   }
   ...
   public String toString() {
      return "Nested uniform scrambling No Cache";
   }
}
