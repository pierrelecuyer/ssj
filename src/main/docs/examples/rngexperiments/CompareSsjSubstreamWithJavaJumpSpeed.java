 ...
 * initialized once before warmup, then timed runs continue from the state reached
 * after warmup.
 */
public class CompareSsjSubstreamWithJavaJumpSpeed {
...
//      FileWriter writer = new FileWriter("CompareSsjSubstreamWithJavaJumpSpeed.res");
...
//      writer.close();
    ...
    private static void printIntro(StringBuilder out) {
        ...
        out.append("- One warmup run is excluded from the timing result.\n");
    ...
    private static void printJumpSectionHeader(StringBuilder out) {
        out.append("============================================================\n");
