...
public class CompareMWCvsCpp {
   ...
   /*This print same values as in c++ tests (MWCSpeed10.res and MWCJump.res)
...
//      writer.close();
    ...
    * for raw vallues
    * */
   private static void printFirstRawValues(int n) {
    ...
    * for i = 0 to n-1:
    *     dsum += MWC64k2a2U01();
    * Java nextDouble() uses the top 53 bits of the 64-bit output.
    */
