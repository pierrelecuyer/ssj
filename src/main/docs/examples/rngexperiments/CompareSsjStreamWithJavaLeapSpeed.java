 ...
 */
public class CompareSsjStreamWithJavaLeapSpeed {
...
//      FileWriter writer = new FileWriter("CompareSsjStreamWithJavaLeapSpeed.res");
...
//      writer.close();
    ...
    private static void benchmarkJavaLeap(StringBuilder out, String algorithm) {
        ...
        out.append("Leap distance reported by Java: ")
           .append(formatPowerOfTwoDistance(gen.leapDistance()))
           .append("\n");
    ...
    private static void printIntro(StringBuilder out) {
        ...
        out.append("- This is a conceptual comparison only; the jump distances and mechanisms are not equal.\n");
        ...
        out.append("- One nextDouble() or nextLong() call is made after each run and added to a sink.\n\n");
    ...
    private static void printStreamSectionHeader(StringBuilder out) {
        out.append("============================================================\n");
    ...
    private static void printFinalSink(StringBuilder out) {
    ...
    private static String formatPowerOfTwoDistance(double distance) {
        if (distance > 0.0) {
