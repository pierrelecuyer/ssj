...
public class TestRQMCSpeed {
   ...
   static RandomStream noise = new LFSR113();
   ...
   public static void main(String[] args) {
      ...
      DigitalNetBase2 p = new SobolSequence(k, 31, s);   // 2^{20} points.
      ...
      PointSetRandomization nus = new NestedUniformScrambling(noise, 30); // NUS

      System.out.println("Speed tests and comparisons for RQMC point sets with 32-bit implementation.");
      System.out.println("See the program TestRQMCSpeed.java for the details.");
