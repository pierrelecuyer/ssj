...
public class HistCollectionLatex {
    ...
    */
   private static String makeHistogramLatex(String filePath, int numBins, String title,
      ...
      scHist.setAxisOptions(titleOptions
            ...
            + "xmin=" + texNum(xmin) + ", xmax=" + texNum(xmax) + ",\n"
   ...
   /**
    * Writes the PGFPlots LaTeX code for one histogram to the output folder.
    *
    * The histogram code is generated by {@link #makeHistogramLatex}.
    *
    * @param filePath      path of the input {@code .dat} file
    * @param outputFolder  directory in which the LaTeX file is written
    * @param numBins       number of histogram bins
    ...
    * @param extremeMarks  two-element array containing the numbers of smallest and
    *                      largest observations to mark
    * @throws IOException if the input data file cannot be read or the output file
    *                     cannot be written
    */
   public static void writeHistogramLatex(String filePath, String outputFolder, int numBins,
         String title, String width, String height, String legendOptions,
         int[] extremeMarks) throws IOException {
      String latex = makeHistogramLatex(filePath, numBins, title, width, height,
            legendOptions, extremeMarks);
      ...
      File outputFile = new File(outputDir, fileName + "-hist.tex");

      try (PrintWriter out = new PrintWriter(new FileWriter(outputFile))) {
         out.print(latex);
         System.out.println("tex written to : " + outputFile.getAbsolutePath());;
      }
   }
   ...
   private static String getLegendOptions(TallyHistogram hist, TallyStore fileStats,
      ...
      return "legend entries={{" + legend + "}}, " + "legend image code/.code={}, " + "legend style={"
