 ...
 * NetworkReliablity13, but does it using CMC.  
 * The first two links Y[0] and Y[1] are not generated.
 * This is for Example  intro-san-reliability-CMC  in the book.
 */
...
public class NetworkReliability13CMC1 extends NetworkReliablity13 {
	...
	public void simulate(RandomStream stream) {
		...
		I1 = ((Y[2] & Y[5] & Y[10]) |
			 ...
			 (Y[3] & Y[6] & Y[11] & Y[12]));
		I2 = (Y[5] & Y[10]);
		if (I1) probConnected = r[0];
		if (I2) probConnected += r[1] * (1.0 - probConnected);
	}
	...
	public static void main(String[] args) throws IOException {
	    ...
	    System.out.println (MonteCarloExperiment.simulateRunsDefaultReportStudent (net, n, new LFSR113(),
				statR, 0.95, 4));
